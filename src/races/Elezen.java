...
public class Elezen extends Race {
	...
	private ArrayList<String>  elezenMNames = new ArrayList<>(Arrays.asList("Adeux", "Beichault", "Dreauchant", "Eauplaux", "Etrent", "Gloffaux", "Jodeaux", "Joyent", "Ulmant", "Ulwex"));
	private ArrayList<String>  elezenFNames = new ArrayList<>(Arrays.asList("Adreanne", "Iflione", "Eaupline", "Eranne", "Etrene", "Moriene", "Peronne", "Cummone", "Phivonne", "Paxeonne"));
	private ArrayList<String> elezenSurnames = new ArrayList<>(Arrays.asList("Breaunojuste", "Douvionne", "Feajorins", "Gehon", "Glauvefand", "Grurubont", "Nahame", "Prihaux", "Shogamie", "Zuhepane"));
