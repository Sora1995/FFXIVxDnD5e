...
- jacocoant.jar: [JaCoCo](https://www.eclemma.org/jacoco/) is an open source code coverage tool. This jar file work with ant requires no dependencies. Originally from the [offical maven repositiry](https://central.sonatype.com/artifact/org.jacoco/org.jacoco.ant/versions)
...
Windows: C:\Program Files\Java\javafx-sdk-25.0.1

Unix: /home/aveliz/javafx-sdk-25.0.1

Note: Some linux distros may also require installing GTK-4, FFMPEG, and libavcodec.
...
javafxc: javac --module-path="C:\Program Files\Java\javafx-sdk-25.0.1\lib" --add-modules="javafx.controls,javafx.media,javafx.fxml" "%f"

javafx: java java -ea --module-path="C:\Program Files\Java\javafx-sdk-25.0.1\lib" --add-modules="javafx.controls,javafx.media,javafx.fxml"  --enable-native-access="javafx.media,javafx.graphics" "%e"

### CLI: 

javac javac --module-path="C:\Program Files\Java\javafx-sdk-25.0.1\lib" --add-modules="javafx.controls,javafx.media,javafx.fxml" Demo.java

java java java -ea --module-path="C:\Program Files\Java\javafx-sdk-25.0.1\lib" --add-modules="javafx.controls,javafx.media,javafx.fxml"  --enable-native-access="javafx.media,javafx.graphics" Demo
